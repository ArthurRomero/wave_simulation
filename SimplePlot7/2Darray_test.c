...
double *gp0(double z,double r0,double el0, double w0, double a[][2], int r, int c);
double *gp1(double z,double r0,double el0, double w0, double a[][2], int r, int c);

double *gp2(double z12,double z23, double mytheta, double el1x, double w1x, double r1x, double el1y, double w1y, double r1y, double G2_x, double a[][2], int r, int c);
...
int main()
{
    ...
    for (int i=0; i<(zpnts-1); i++)
    {
       ...
       double zloc = zstart + i*zres;
        ...
        //double (*q) = gp0(zstart + zres*1,r0,el0,w0,ix,r,c);//gp0
...
double *gp1(double z12,double r1,double el1, double w1, double a[][2], int rows, int c)
{
    double coef;
