...
double (*gp1(double z12,double r0,double el0, double w0, double a[][2], int rows, int col))[2];//prototype

double (*gp2(double z12,double z23, double mytheta, double el1x, double w1x, double r1x, double el1y, double w1y, double r1y, double G2_x, double a[][2], int rows, int col))[2];//prototype
...
double sinc(double x)
{
    ...
    {
        sinc = (sin(x))/x;// it avoids a division by 0
    }
            ...
            for (int m2=-lim; m2<=lim; m2++) {
                for (int n1=-lim; n1<=lim; n1++) {
                    for (int n2=-lim; n2<=lim; n2++) {
                        ...
                        a5 = (x2pnts((float *)ReT, rowsT, m1));
                        b = (x2pnts((float *)ReT, rowsT, m2));
                        c5 = (x2pnts((float *)ReT, rowsT, n1));
                        d5 = (x2pnts((float *)ReT, rowsT, n2));
